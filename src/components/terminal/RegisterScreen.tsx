  ...
  return (
    <div className="fixed inset-0 bg-lb-bg z-[110] flex flex-col animate-in slide-in-from-right font-sans">
      <div className="flex items-center p-4 bg-lb-panel shadow-sm shrink-0">
        ...
        <h1 className="text-xl font-bold text-lb-text ml-2">Create Account</h1>
      </div>
      ...
      <div className="flex-1 overflow-y-auto p-6 flex flex-col justify-center">
        <div className="bg-lb-panel rounded-3xl p-6 shadow-xl shadow-black/5 flex flex-col gap-6">
          ...
          <div className="text-center mb-2">
            ...
            <h2 className="text-2xl font-bold text-lb-text tracking-tight">Register</h2>
            <p className="text-lb-text-muted text-[15px] mt-1">Set up your trading credentials</p>
          </div>

          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            <div className="flex flex-col gap-1.5">
              <label className="text-sm font-semibold text-lb-text ml-1">Username</label>
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <div className="relative">
                ...
                <button
                  ...
                  className="absolute inset-y-0 right-0 pr-4 flex items-center text-lb-text-muted hover:text-lb-text transition-colors"
                  tabIndex={-1}
                >
            ...
            <div className="flex flex-col gap-1.5">
              <label className="text-sm font-semibold text-lb-text ml-1">Confirm Password</label>
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-lb-text-muted">
                  <Lock size={18} />
                </div>
